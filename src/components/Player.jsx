      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-1" onClick={e => e.stopPropagation()}>
            <button onClick={() => { pulse(); toggleFavorite(currentVideo); }} className={`w-10 h-10 rounded-full flex items-center justify-center transition-all active:scale-90 ${isFav ? 'text-white bg-white/[0.07]' : 'text-white'}`}>
